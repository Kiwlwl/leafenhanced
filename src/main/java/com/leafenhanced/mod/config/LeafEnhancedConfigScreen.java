...
public class LeafEnhancedConfigScreen {
    public static Screen create(Screen parent) {
        ...
        leaves.addEntry(entryBuilder.startFloatField(Component.translatable("option.leafenhanced.baseWindStrength"), config.baseWindStrength)
                ...
                .build());
        leaves.addEntry(entryBuilder.startBooleanToggle(Component.translatable("option.leafenhanced.windSounds"), config.windSounds)
                .setDefaultValue(true)
                .setTooltip(Component.translatable("option.leafenhanced.windSounds.tooltip"))
                .setSaveConsumer(v -> config.windSounds = v)
                .build());
        leaves.addEntry(entryBuilder.startBooleanToggle(Component.translatable("option.leafenhanced.stormGusts"), config.stormGusts)
                .setDefaultValue(true)
                .setTooltip(Component.translatable("option.leafenhanced.stormGusts.tooltip"))
                .setSaveConsumer(v -> config.stormGusts = v)
                .build());
